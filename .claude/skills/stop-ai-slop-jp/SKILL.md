...
`.py` を変更したときは、同ファイルの「8. Python ファイルを直したあとの確認」に沿って
Pyright で import の解決を確かめる。

## リファレンス

- `references/textbook.md` — 技術教材モード。比喩・界隈語の置換表、目的を指す見出し、
  初出用語、読者の行動に繋がらない記述の削除基準、表と箇条書きの上限。
