...
- **境界** — 情報が部分的にしか無い、観点が多い、など苦手になりやすい入力
...
expect のキーは 12.2 の 5 種類です。書かれていないルールは適用しないこと。

## 12.4 【ハンズオン】ケースを 2 件追加する
...
```bash
uv run --project 07-full-app pytest 12-evaluation/verify -q
```

`5 passed` で合格です。

## 12.5 【ハンズオン・要 AWS】改善ループを一周する
...
[第13章 プロンプトインジェクション](../13-security/)
