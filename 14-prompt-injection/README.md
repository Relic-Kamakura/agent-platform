...
防御は 1 つの対策だけでは成立しません。層は 3 つに大別できます。プロンプト層（この章で書く）、
...
依頼だけです」と**信頼できる指示源を定義する**方が、乗っ取りを防ぎやすくなります。
...
- `prompt` は reviews fixture が検索結果として返ってくる調査依頼
  （例: 「Acme と Globex の reviews を調べて」）
